...
LDFLAGS += -extldflags '-static' \
  -X github.com/gman0/kcp-cache-syncagent/internal/version.gitVersion=$(GIT_VERSION) \
  -X github.com/gman0/kcp-cache-syncagent/internal/version.gitHead=$(GIT_HEAD)
LDFLAGS_EXTRA ?= -w
